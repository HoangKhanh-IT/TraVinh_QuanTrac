...
1. https://github.com (HoangKhanh-IT/gs@123456)
2. Cài đặt trong phpStorm có VCS -> GIT ->remotes... đưa vào trang https://github.com/HoangKhanh-IT/TraVinh_QuanTrac.git hoặc https://github.com/nguyenduclam/TraVinh_QuanTrac.git. Để sử dụng ctrl+k và ctrl+shift+k 
3. Cài đặt GIT Bass để để dùng lệnh lấy source về máy git clone -b nguyenduclam https://github.com/nguyenduclam/TraVinh_QuanTrac.git

Cấu hình:
1. Database chạy câu lệnh sql (bỏ cấu trúc bảng) và backup lại file .bak
2. Cấu hình database tương ứng trong config.php trong Services
